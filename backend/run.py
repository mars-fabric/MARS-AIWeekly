#!/usr/bin/env python3
"""
Simple script to run the AI Weekly backend server
"""
...
if __name__ == "__main__":
    ...
    logger.info("Starting AI Weekly Backend Server")
    ...
    work_dir = os.getenv("AIWEEKLY_DEFAULT_WORK_DIR", "~/Desktop/cmbdir/aiweekly")
    ...
    # Set AIWEEKLY_DEBUG=true or AIWEEKLY_ENABLE_RELOAD=true to enable reload
    debug_mode = os.getenv("AIWEEKLY_DEBUG", "false").lower() == "true"
    enable_reload_env = os.getenv("AIWEEKLY_ENABLE_RELOAD", "false").lower() == "true"
    ...
    if enable_reload:
        ...
        logger.warning("Auto-reload should be disabled in production. Set AIWEEKLY_DEBUG=false")
    else:
